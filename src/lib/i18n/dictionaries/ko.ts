export const ko = {
  ...
  'menu.attendanceRegister': '근태대장',
  'menu.attendanceImport': '근태 일괄 등록',
  'menu.attendanceCloseout': '근태 마감',
  'menu.leaveRegister': '연차대장',
  'menu.leaveRequests': '휴가 신청·승인',
  'menu.salaryBase': '급여 기준액',
  'menu.payrollCalculate': '급여 계산',
  'menu.payrollRegister': '급여대장',
  'menu.severance': '퇴직금',
  'menu.yearEndTax': '연말정산',
  'menuDesc.home': '이번 주 할 일과 이번 달 마감 현황',
  'menuDesc.workforce': '인력대장·입퇴사·발령',
  'menuDesc.timeAndLeave': '근태대장·연차대장·신청 승인',
  'menuGroup.workforce': '인력관리',
  'menuGroup.organization': '조직관리',
  'menuGroup.timeAndLeave': '근태·휴가',
